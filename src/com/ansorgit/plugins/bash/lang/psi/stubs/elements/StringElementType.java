...
public class StringElementType extends BashStubElementType<BashLanguageInjectionStub, BashLanguageInjectionHost> {
    public StringElementType() {
        super("string type");
    }
