...
public class SimpleCommandParsingFunctionTest extends MockPsiTest {
    ...
    public void testParsingArrayVar() throws Exception {
        ...
        //a=(["x"]=1)
        mockTest(function, ASSIGNMENT_WORD, EQ, LEFT_PAREN, LEFT_SQUARE, STRING_BEGIN, WORD, STRING_END, RIGHT_SQUARE, EQ, WORD, RIGHT_PAREN);

        //${x[ ( 1+1 ) ]}
        mockTest(function, DOLLAR, LEFT_CURLY, WORD, LEFT_SQUARE, LEFT_PAREN, NUMBER, ARITH_PLUS, NUMBER, RIGHT_PAREN, RIGHT_SQUARE, RIGHT_CURLY);

        //${x[ (( 1+1 )) ]}
        mockTest(function, DOLLAR, LEFT_CURLY, WORD, LEFT_SQUARE, EXPR_ARITH, NUMBER, ARITH_PLUS, NUMBER, _EXPR_ARITH, RIGHT_SQUARE, RIGHT_CURLY);
    }
}