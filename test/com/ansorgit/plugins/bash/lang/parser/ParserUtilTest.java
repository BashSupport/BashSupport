...
public class ParserUtilTest {
    ...
    public void testLookahead() {
        BashPsiBuilder b = new BashPsiBuilder(null, new MockPsiBuilder(WORD, WHITESPACE, WHITESPACE, ARITH_NUMBER), Bash_v3);
        Assert.assertEquals(WORD, b.lookAhead(0));
        Assert.assertEquals(ARITH_NUMBER, b.lookAhead(1));
    }
